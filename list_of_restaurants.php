<html> <head> <title>List of KL Restaurant</title> </head> <body> <center> <h1>List of KL Restaurant</h1> <!--create table structure using HTML first--> 
  <table border="1"> 
  ...
  <?php  
$serverName = "simplewebtp048140.database.windows.net"; $connectionOptions = array( "Database" => "simplewebtp048140v2", "Uid" => "simpleweb", "PWD" => "Simple@web"); 
